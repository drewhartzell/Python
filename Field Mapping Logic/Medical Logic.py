...
## Billing Provider Info
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and (any(substring in column_name.lower() for substring in ['2']))
                    and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                        mapping[column_name] = 'Billing Provider Address 2' 
# Encompasses values that are alphanumberical, include periods, commas, and pound signs
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'Billing Provider Address'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and all((str(value).replace("-", "").replace(" ", "").isalpha()) for value in values)):
                    mapping[column_name] = 'Billing Provider City'
# Encompasses values that are only alpha characters and hyphenated cities
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and all((str(value).replace(" ", "").isalpha()) for value in values)):
                    mapping[column_name] = 'Billing Provider State'
# Encompasses values that are only alpha characters
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and all((str(value).replace("-", "").replace(" ", "").isdigit()) for value in values)):
                    mapping[column_name] = 'Billing Provider Zip Code'
# Encompasses values that are 5 digits long or hyphenated 9 digit zip codes
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and all((str(value).replace("-", "").replace(" ", "").isdigit() for value in values))):
                    mapping[column_name] = 'Billing Provider NPI'
# Encompasses values that are alphanumberical and have hyphens when applicable
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and all((str(value).replace("-", "").replace(",", "").replace(" ", "").isalpha() for value in values))):
                    mapping[column_name] = 'Billing Provider Name'
# Encompasses values that are only alpha characters and hyphenated cities   
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalpha() for value in values))):
                    mapping[column_name] = 'Billing Provider ID Type'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'Billing Provider Specialty Code'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs    
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['bill','billing']))
                and all((str(value).replace("-", "").replace(" ", "").isalnum()) or (str(value).replace("-", "").replace(" ", "").isdigit()) for value in values)):
                    mapping[column_name] = 'Billing Provider ID'
# Encompasses values that are alphanumberical and have hyphens when applicable                
...
## Performing Provider Info
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and (any(substring in column_name.lower() for substring in ['2']))
                    and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                        mapping[column_name] = 'Performing Provider Address 2' 
# Encompasses values that are alphanumberical, include periods, commas, and pound signs
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'Performing Provider Address'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace("-", "").replace(" ", "").isalpha()) for value in values)):
                    mapping[column_name] = 'Performing Provider City'
# Encompasses values that are only alpha characters and hyphenated cities
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace(" ", "").isalpha()) for value in values)):
                    mapping[column_name] = 'Performing Provider State'
# Encompasses values that are only alpha characters
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace("-", "").replace(" ", "").isdigit()) for value in values)):
                    mapping[column_name] = 'Performing Provider Zip Code'
# Encompasses values that are 5 digits long or hyphenated 9 digit zip codes
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace("-", "").replace(" ", "").isdigit()) for value in values)):
                    mapping[column_name] = 'Performing Provider NPI'
# Encompasses values that are alphanumberical and have hyphens when applicable
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace("-", "").replace(",", "").replace(" ", "").isalpha()) for value in values)):
                    mapping[column_name] = 'Performing Provider Name'
# Encompasses values that are only alpha characters and hyphenated cities   
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalpha()) for value in values)):
                    mapping[column_name] = 'Performing Provider ID Type'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum()) for value in values)):
                    mapping[column_name] = 'Performing Provider Specialty Code'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs  
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace("-", "").replace(" ", "").isalnum()) for value in values)):
                    mapping[column_name] = 'Performing Provider ID'
# Encompasses values that are alphanumberical and have hyphens when applicable  
...
# Encompasses values that are alphanumberical and have hyphens when applicable
    ...
    elif (any(substring in column_name.lower() for substring in ['drg'])
        and all((str(value).replace(".", "").replace(" ", "").isdigit() for value in values))):
            mapping[column_name] = 'DRG'
# Encompasses values that are alphanumberical and have hyphens when applicable
            
    elif (any(substring in column_name.lower() for substring in ['revenue','rev'])
        and (any(substring in column_name.lower() for substring in ['code', 'cd']))
            and all((str(value).replace(".", "").replace(" ", "").isdigit() for value in values))):
                mapping[column_name] = 'Revenue Code'
# Encompasses values that are alphanumberical and have hyphens when applicable
        ...
        and (any(substring in column_name.lower() for substring in ['prov', 'provider']))
            and (any(substring in column_name.lower() for substring in ['perf','performing','serv','servicing']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'Place of Service'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs  
                    
    elif (any(substring in column_name.lower() for substring in ['procedure','proc'])
        and (any(substring in column_name.lower() for substring in ['modifier', 'mod']))
            and (any(substring in column_name.lower() for substring in ['1']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'Procedure Modifier 1'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs  
        ...
        and (any(substring in column_name.lower() for substring in ['modifier', 'mod']))
            and (any(substring in column_name.lower() for substring in ['2']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'Procedure Modifier 2'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs  

    elif (any(substring in column_name.lower() for substring in ['network'])
        and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
            mapping[column_name] = 'Network'            
# Encompasses values that are alphanumberical, include periods, commas, and pound signs

    elif (any(substring in column_name.lower() for substring in ['units','services'])
            and (any(substring in column_name.lower() for substring in ['number', 'num']))
                and all((str(value).replace(".", "").replace(" ", "").isdigit() for value in values))):
                    mapping[column_name] = 'Number of Units (Primary)'
# Encompasses values that are numerical and have periods
                    
    elif (any(substring in column_name.lower() for substring in ['claim'])
            and (any(substring in column_name.lower() for substring in ['type']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'Claim Type'
# Encompasses values that are numerical and have periods
                    
    elif (any(substring in column_name.lower() for substring in ['claim bill', 'cmsbill','cms'])
            and (any(substring in column_name.lower() for substring in ['type']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'CMS Bill Type Code'
# Encompasses values that are numerical and have periods
...
# Encompasses values that are numerical and have periods
    ...
    elif (any(substring in column_name.lower() for substring in ['er','emergency','emergencyroom'])
            and (any(substring in column_name.lower() for substring in ['ind','indicator']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'Emergency Room Indicator'
# Encompasses values that are numerical and have periods
                    
    elif (any(substring in column_name.lower() for substring in ['diagnosis','diag'])
        and (any(substring in column_name.lower() for substring in ['cd','code']))
                and all((str(value).replace(".", "").replace("#", "").replace(",", "").replace(" ", "").isalnum() for value in values))):
                    mapping[column_name] = 'Diagnosis Code(s)'
# Encompasses values that are numerical and have periods

    elif (any(substring in column_name.lower() for substring in ['icd'])
            and (any(substring in column_name.lower() for substring in ['cd','code','procedure']))
                and (any(substring in column_name.lower() for substring in ['type','ty']))
                    and all((str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isalnum() or str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isalpha() or str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isdigit() for value in values))):
                        mapping[column_name] = 'ICD Procedure Type Code'
# Encompasses values that are numerical and have periods
                        
    elif (any(substring in column_name.lower() for substring in ['hcpc','hcpcs','cpt'])
        and (any(substring in column_name.lower() for substring in ['cd','code','procedure']))
                and (any(substring in column_name.lower() for substring in ['type','ty']))
                    and all((str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isalnum() or str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isalpha() or str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isdigit() for value in values))):
                        mapping[column_name] = 'HCPCS/CPT Procedure Type Code'
# Encompasses values that are numerical and have periods                

    elif (any(substring in column_name.lower() for substring in ['icd'])
        and (any(substring in column_name.lower() for substring in ['cd','code','procedure']))
                and all((str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isalnum() or str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isdigit() for value in values))):
                    mapping[column_name] = 'ICD Procedure Code(s)'
# Encompasses values that are numerical and have periods
                    
    elif (any(substring in column_name.lower() for substring in ['hcpc','hcpcs','cpt'])
            and (any(substring in column_name.lower() for substring in ['procedure','code','cd']))
                and all((str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isalnum() or str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isdigit() for value in values))):
                    mapping[column_name] = 'HCPCS/CPT Procedure Code(s)'
# Encompasses values that are numerical and have periods
            ...
            and (any(substring in column_name.lower() for substring in ['cd','code']))
                and (any(substring in column_name.lower() for substring in ['type','ty']))
                    and all((str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isalnum() or str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isalpha() or str(value).replace(".", "").replace("#", "").replace("-", "").replace(" ", "").isdigit()) for value in values)):
                        mapping[column_name] = 'Diagnosis Type Code'
# Encompasses values that are numerical and have periods
    
    elif (any(substring in column_name.lower() for substring in ['place'])
            and (any(substring in column_name.lower() for substring in ['cd','code']))
